...
{                                                                                //:::::Here be variables:::::
    ...
    public readonly float MaxX = 37.18f;                                        //This is the eastern border of the map
    public readonly float MinX = -37.18f;                                       //This is the western border of the map
    ...
    private readonly float Wrap = 92.159f;                                       //This is one camera's space away from a border plus a camera's space off the border on the opposite side //57.601f
    private readonly float FarMaxX = 54.979f;                                     //This is one camera's space away from the eastern border //37.69f 46.08
